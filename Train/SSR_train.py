...
from preprocess.transformation import data_loader
...
filepath = "../Output/output_1/weights-improvement-{epoch:02d}-{val_loss:.2f}.h5"
...
np.save('../Output/output_1/hist.npy', hist.history, allow_pickle=True)
